...
/// [UICalendarItem.shiftEventTo]) and then call setState to update the UI.
typedef EventDragCallback = Function(UICalendarItem calendarItem, DateTime newStartTime);
