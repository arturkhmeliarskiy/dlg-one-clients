...
_$_AppEnvironment _$$_AppEnvironmentFromJson(Map<String, dynamic> json) =>
    _$_AppEnvironment(
      ...
      matrixServerUrl: json['matrixServerUrl'] as String,
      matrixSignalUrl: json['matrixSignalUrl'] as String,
      sipServerUrl: json['sipServerUrl'] as String,
      socketApiUrl: json['socketApiUrl'] as String,
      matrixDatabaseName: json['matrixDatabaseName'] as String,
      matrixAppId: json['matrixAppId'] as String,
      matrixClientName: json['matrixClientName'] as String,
      matrixPusherName: json['matrixPusherName'] as String,
    );
...
Map<String, dynamic> _$$_AppEnvironmentToJson(_$_AppEnvironment instance) =>
    <String, dynamic>{
      ...
      'matrixServerUrl': instance.matrixServerUrl,
      'matrixSignalUrl': instance.matrixSignalUrl,
      'sipServerUrl': instance.sipServerUrl,
      'socketApiUrl': instance.socketApiUrl,
      'matrixDatabaseName': instance.matrixDatabaseName,
      'matrixAppId': instance.matrixAppId,
      'matrixClientName': instance.matrixClientName,
      'matrixPusherName': instance.matrixPusherName,
    };
