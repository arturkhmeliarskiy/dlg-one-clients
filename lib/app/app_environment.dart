...
class AppEnvironment with _$AppEnvironment {
  ...
  /// [restApiUrl] - параметр указывающий на RestAPI сервер
  /// [matrixServerUrl] - параметр указывающий на Matrix сервер
  /// [matrixSignalUrl] - параметр указывающий на Matrix Signal сервер куда будут приходить оповещения
  /// [sipServerUrl] - параметр указывающий на SIP звонилку
  /// [socketApiUrl] - параметр указывающий на SocketAPI сервер
  const factory AppEnvironment({
    ...
    required String matrixServerUrl,
    required String matrixSignalUrl,
    required String sipServerUrl,
    required String socketApiUrl,
    required String matrixDatabaseName,
    required String matrixAppId,
    required String matrixClientName,
    required String matrixPusherName,
  }) = _AppEnvironment;
