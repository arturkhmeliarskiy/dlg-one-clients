...
class DLSNotificationsHistoryChatsBuilder extends StatelessWidget {
  const DLSNotificationsHistoryChatsBuilder({
    super.key,
  });
                        ...
                        child: DLSNotificationWidgetBuilder.build(
                          contentCallbacks: ContentCallbacks.fromNotification(
                            state.chatNotifications[
                                state.chatNotifications.length - 1 - i],
                            context,
                          ),
                          notification: state.chatNotifications[
                              state.chatNotifications.length - 1 - i],
