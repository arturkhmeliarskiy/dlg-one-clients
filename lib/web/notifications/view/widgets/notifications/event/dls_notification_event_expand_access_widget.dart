...
/// предоставил вам доступ к мероприятию
class DLSNotificationEventExpandAccessWidget extends StatelessWidget {
  const DLSNotificationEventExpandAccessWidget({
  ...
  Widget build(BuildContext context) {
    return DLSNotificationUserParentWidget(
      ...
      dataLevel1: S.current.eventExpandAccess,
