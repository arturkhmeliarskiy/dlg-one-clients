...
/// комментарий на мероприятие
class DLSNotificationChatAddEventCommentWidget extends StatelessWidget {
  const DLSNotificationChatAddEventCommentWidget({
  ...
  Widget build(BuildContext context) {
    return DLSNotificationUserParentWidget(
      ...
      dataLevel1: S.current.chatAddEventComment,
