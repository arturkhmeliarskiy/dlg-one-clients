...
/// изменили имя группы
class DLSNotificationChatChangeGroupNameWidget extends StatelessWidget {
  const DLSNotificationChatChangeGroupNameWidget({
  ...
  Widget build(BuildContext context) {
    return DLSNotificationUserParentWidget(
      ...
      dataLevel1: S.current.chatChangeGroupName,
