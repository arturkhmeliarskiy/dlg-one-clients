...
/// пользователей добавили в группу
class DLSNotificationChatAddGroupUsersWidget extends StatelessWidget {
  const DLSNotificationChatAddGroupUsersWidget({
  ...
  Widget build(BuildContext context) {
    return DLSNotificationUserParentWidget(
      ...
      dataLevel1: S.current.chatAddGroupUsers,
