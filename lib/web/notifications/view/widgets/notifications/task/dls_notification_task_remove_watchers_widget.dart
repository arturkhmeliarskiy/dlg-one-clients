...
/// удалили наблюдателей у задачи
class DLSNotificationTaskRemoveWatchersWidget extends StatelessWidget {
  const DLSNotificationTaskRemoveWatchersWidget({
  ...
  Widget build(BuildContext context) {
    return DLSNotificationUserParentWidget(
      ...
      dataLevel1: S.current.taskRemoveWatchers,
