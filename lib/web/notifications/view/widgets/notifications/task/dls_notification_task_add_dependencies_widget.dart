...
/// добавили зависимости к задаче
class DLSNotificationTaskAddDependenciesWidget extends StatelessWidget {
  const DLSNotificationTaskAddDependenciesWidget({
  ...
  Widget build(BuildContext context) {
    return DLSNotificationUserParentWidget(
      ...
      dataLevel1: S.current.taskAddDependencies,
