...
class DLSNotificationTaskUnlockWidget extends StatelessWidget {
  const DLSNotificationTaskUnlockWidget({
  ...
  Widget build(BuildContext context) {
    return DLSNotificationUserParentWidget(
      ...
      dataLevel1: S.current.taskUnlock,
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: DLSTaskUnLockName(name: object.name, lock: false),
          ),
          Wrap(
