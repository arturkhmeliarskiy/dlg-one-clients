...
/// удалили спринты из задачи
class DLSNotificationTaskRemoveSprintsWidget extends StatelessWidget {
  const DLSNotificationTaskRemoveSprintsWidget({
  ...
  Widget build(BuildContext context) {
    return DLSNotificationUserParentWidget(
      ...
      dataLevel1: S.current.taskRemoveSprints,
