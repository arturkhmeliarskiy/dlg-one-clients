...
import 'package:dls_one/web/tasks/view/mobile/task_list/filters/mobile_filter_tags_content.dart';
import 'package:dls_one/web/tasks/view/mobile/task_list/filters/mobile_list_tags.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class MobileFilterTags extends StatefulWidget {
  ...
  @override
  State<MobileFilterTags> createState() => _MobileFilterTagsState();
}

class _MobileFilterTagsState extends State<MobileFilterTags> {
  ...
  @override
  void didUpdateWidget(covariant MobileFilterTags oldWidget) {
              ...
              builder: (context, state) {
                return MobileFilerTagsContent(
                  ...
                  onChangeTags: (value) {
                    ...
                    widget.onChangeTags(_selectedIds);
                  },
                  items: state.model.tags,
                );
              },
            );
          },
