...
class FilterStatusCustomButton extends StatefulWidget {
  const FilterStatusCustomButton({
  ...
  final List<StatusItem> selectedItems;
  final bool isMenuOpen;
  final String hint;

  @override
  State<FilterStatusCustomButton> createState() =>
      _FilterStatusCustomButtonState();
}

class _FilterStatusCustomButtonState extends State<FilterStatusCustomButton> {
  @override
